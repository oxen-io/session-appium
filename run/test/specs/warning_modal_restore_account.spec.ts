...
import { SeedPhraseInput, BackButton, SlowModeRadio, ContinueButton, AccountRestoreButton, WarningModalQuitButton } from "./locators/onboarding";
...
async function warningModalRestoreAccount(platform: SupportedPlatformsType) {
    ...
    const seedPhrase = 'eldest fazed hybrid buzzer nasty domestic digit pager unusual purged makeup assorted domestic'
